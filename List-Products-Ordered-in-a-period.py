...
df = orders[orders['order_date'].between('2020-02-01','2020-02-29')].groupby('product_id')['unit'].sum().reset_index()
print(df[df['unit']>=100].merge(products, on = 'product_id', how = 'left')[['product_name','unit']])